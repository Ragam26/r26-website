    ...
    >
      <div className="flex gap-2 flex-1">
        <div className="w-5 flex flex-[1.2] flex-col gap-2">
          <div
            ...
            style={{ backgroundImage: "url('https://cdn.ragam.co.in/card/premBg.svg')" }}
          />
      ...
      <div className="flex gap-2 h-15">
        ...
        <div className="w-12.5 relative flex items-center justify-center bg-[#730000] group-hover:bg-[#FFDEAC] transition-colors bg-cover bg-center">
          <div className="bg-[url(https://cdn.ragam.co.in/card/premArrow.svg)] group-hover:bg-[url(https://cdn.ragam.co.in/card/normArrow.svg)] group-hover:rotate-12 transition-500 transition-all bg-fit bg-no-repeat bg-center w-full h-full flex items-center justify-center" />
        </div>
      </div>
