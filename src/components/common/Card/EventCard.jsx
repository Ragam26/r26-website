  ...
  const inner = (
    <>
      <div className="flex gap-2 flex-1">
        <div className="w-5 flex flex-[1.2] flex-col gap-2">
          ...
          <div className={`${commonBorderStyle} flex-1 flex flex-col justify-between items-center text-[#730000] group-hover:text-[#FFDEAC] py-4 transition-colors`}>
            ...
            <div className="relative w-full flex justify-center">
              <div className="w-[70%] md:flex hidden h-px bg-[#730000] group-hover:bg-[#FFDEAC] transition-colors -rotate-45" />
            </div>
        ...
        {/* Main Image — no longer a link, click is handled by the card */}
      ...
      {expDate && (
        <div className="h-7.5 border border-[#730000] group-hover:border-[#FFDEAC] transition-colors flex items-center justify-center">
          <span className={`${playfair.className} text-[14px] text-[#730000] group-hover:text-[#FFDEAC] transition-colors font-medium`}>
            Click to Register
          </span>
        </div>
      )}
