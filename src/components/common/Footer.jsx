    ...
    <footer className='bg-black text-white'>
      <div className='relative max-w-7xl mx-auto px-6 pt-5 pb-5'>
        ...
        <div className='w-full text-center md:mb-5 md:mt-10 mb-5'>
          <h1 className='text-[21vw] md:text-[16vw] md:font-bold font-extrabold tracking-tight sm:tracking-normal leading-none flex justify-center gap-2 md:scale-y-120 scale-y-100 origin-bottom'>
            {letters.map((letter) => (
              <span
                key={letter.id}
                onPointerEnter={(e) => {
